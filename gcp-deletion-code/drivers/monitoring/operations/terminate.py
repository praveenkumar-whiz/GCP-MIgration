...
def terminate_spec(spec: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        logger.info("Connected to GCP Cloud Monitoring service | Project=%s", project_id)

        logger.info("=== GCP CLOUD MONITORING FULL CLEANUP STARTED | Project=%s ===", project_id)
        ...
        # ------------------------------------------------------------
        logger.info("GCP Cloud Monitoring cleanup COMPLETED | Project=%s | "
