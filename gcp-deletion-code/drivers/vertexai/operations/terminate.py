...
def terminate_spec(spec: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        # ========================================================
        logger.info("=== STEP 2: Discovering Vertex AI Endpoints ===")
        
        # Vertex AI Endpoints are global resources
        location = "global"
        ...
        while True:
            ...
            response = aiplatform_client.request(
                "GET",
                "projects/{}/locations/{}/endpoints".format(project_id, location),
                params=params,
            )
        ...
        logger.info("Vertex AI Endpoints discovered | Count=%d", len(all_endpoints))
