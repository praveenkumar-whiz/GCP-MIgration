                ...
                for trigger in all_triggers:
                    ...
                    try:
                        ...
                        deleted_resources["failed_deletions"].append({
                            "resource_type": "Eventarc Trigger",
            ...
            try:
                ...
                for channel in all_channels:
                    ...
                    try:
                        ...
                        deleted_resources["failed_deletions"].append({
                            "resource_type": "Eventarc Channel",
            ...
            try:
                ...
                for message_bus in all_message_buses:
                    ...
                    try:
                        ...
                        deleted_resources["failed_deletions"].append({
                            "resource_type": "Eventarc Message Bus",
                            "resource_name": message_bus_name,
                            "region": region,
                            "error": str(e)
                        })
            ...
            try:
                ...
                for pipeline in all_pipelines:
                    ...
                    try:
                        ...
                        deleted_resources["failed_deletions"].append({
                            "resource_type": "Eventarc Pipeline",
