                ...
                for forwarding_rule in all_global_forwarding_rules:
                    ...
                    try:
                        ...
                        deleted_resources["failed_deletions"].append({
                            "resource_type": "Global Forwarding Rule",
            ...
            try:
                ...
                for forwarding_rule in all_regional_forwarding_rules:
                    ...
                    try:
                        ...
                        deleted_resources["failed_deletions"].append({
                            "resource_type": "Regional Forwarding Rule",
                            "resource_name": forwarding_rule_name,
                            "region": region,
                            "error": str(e)
                        })
            ...
            try:
                ...
                for proxy in all_global_target_http_proxies:
                    ...
                    try:
                        ...
                        deleted_resources["failed_deletions"].append({
                            "resource_type": "Global Target HTTP Proxy",
            ...
            try:
                ...
                for proxy in all_regional_target_http_proxies:
                    ...
                    try:
                        ...
                        deleted_resources["failed_deletions"].append({
                            "resource_type": "Regional Target HTTP Proxy",
                            "resource_name": proxy_name,
                            "region": region,
                            "error": str(e)
                        })
            ...
            try:
                ...
                for proxy in all_global_target_https_proxies:
                    ...
                    try:
                        ...
                        deleted_resources["failed_deletions"].append({
                            "resource_type": "Global Target HTTPS Proxy",
                            "resource_name": proxy_name,
                            "error": str(e)
                        })
            ...
            try:
                ...
                for proxy in all_regional_target_https_proxies:
                    ...
                    try:
                        ...
                        deleted_resources["failed_deletions"].append({
                            "resource_type": "Regional Target HTTPS Proxy",
                            "resource_name": proxy_name,
                            "region": region,
                            "error": str(e)
                        })
            ...
            try:
                ...
                for proxy in all_global_target_tcp_proxies:
                    ...
                    try:
                        ...
                        deleted_resources["failed_deletions"].append({
                            "resource_type": "Global Target TCP Proxy",
                            "resource_name": proxy_name,
                            "error": str(e)
                        })
            ...
            try:
                ...
                for proxy in all_regional_target_tcp_proxies:
                    ...
                    try:
                        ...
                        deleted_resources["failed_deletions"].append({
                            "resource_type": "Regional Target TCP Proxy",
                            "resource_name": proxy_name,
                            "region": region,
                            "error": str(e)
                        })
            ...
            try:
                ...
                for url_map in all_global_url_maps:
                    ...
                    try:
                        ...
                        deleted_resources["failed_deletions"].append({
                            "resource_type": "Global URL Map",
                            "resource_name": url_map_name,
                            "error": str(e)
                        })
            ...
            try:
                ...
                for url_map in all_regional_url_maps:
                    ...
                    try:
                        ...
                        deleted_resources["failed_deletions"].append({
                            "resource_type": "Regional URL Map",
                            "resource_name": url_map_name,
                            "region": region,
                            "error": str(e)
                        })
            ...
            try:
                ...
                for backend_service in all_global_backend_services:
                    ...
                    try:
                        ...
                        deleted_resources["failed_deletions"].append({
                            "resource_type": "Global Backend Service",
                            "resource_name": backend_service_name,
                            "error": str(e)
                        })
            ...
            try:
                ...
                for backend_service in all_regional_backend_services:
                    ...
                    try:
                        ...
                        deleted_resources["failed_deletions"].append({
                            "resource_type": "Regional Backend Service",
                            "resource_name": backend_service_name,
                            "region": region,
                            "error": str(e)
                        })
                ...
                for backend_bucket in all_backend_buckets:
                    ...
                    try:
                        ...
                        deleted_resources["failed_deletions"].append({
                            ...
                            "resource_name": backend_bucket_name,
                            "error": str(e)
                        })
            ...
            try:
                ...
                for health_check in all_global_health_checks:
                    ...
                    try:
                        ...
                        deleted_resources["failed_deletions"].append({
                            "resource_type": "Global Health Check",
                            "resource_name": health_check_name,
                            "error": str(e)
                        })
            ...
            try:
                ...
                for health_check in all_regional_health_checks:
                    ...
                    try:
                        ...
                        deleted_resources["failed_deletions"].append({
                            "resource_type": "Regional Health Check",
                            "resource_name": health_check_name,
                            "region": region,
                            "error": str(e)
                        })
